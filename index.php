...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
          href="<?php echo $BASE_URL ?>assets/favicons/android-icon-192x192.png">
    ...
    <meta name="description"
          content="Nice Places è un'app che ti permette di conoscere i luoghi di interesse storico e culturale nelle tue vicinanze, offrendoti una descrizione sulle opere per soddisfare la tua curiosità."/>
        ...
        <div class="container container-navbar">
            ...
            <div class="flex-row-reverse collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#chisiamo"><?php echo t("chi-siamo") ?></a>
                    </li>
                        ...
                        case "it": ?>
                            <a href='https://play.google.com/store/apps/details?id=com.niceplaces.niceplaces'>
                                <img alt='Disponibile su Google Play'
                                     class='lang-it google-play-badge'
                                     src='https://play.google.com/intl/en_us/badges/images/generic/it_badge_web_generic.png'/>
                            </a>
                            <a href="<?php echo $BASE_URL ?>app/">
                                <img alt='Disponibile come web app'
                                     class='lang-it google-play-badge'
                                     src='<?php echo $BASE_URL ?>assets/webapp-badge.png'/>
                            </a>
                            <?php break;
                        case "en": ?>
                            <a href='https://play.google.com/store/apps/details?id=com.niceplaces.niceplaces'>
                    ...
                    <div class="row mx-auto my-auto">
                        <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                            <div class="carousel-inner w-100" role="listbox">
                                <?php
                                $img = array("screen1.png", "screen2.png", "screen3.png", "screen4.png", "screen5.png",
...
<div class="container" style="padding-top: 0">
    <section>
        <div class="row">
            <div class="col">
                <a class="anchor" name="chisiamo"></a>
                <h2 class="section-header"><?php echo t("chi-siamo") ?></h2>
            </div>
        </div>
            ...
            <div class="col-12 col-sm-4">
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.facebook.com/melania.anichini">
                            <div class="profile-picture"
                                 style="background-image: url(<?php echo $BASE_URL ?>assets/profile-pictures/melania.jpg)">
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.facebook.com/melania.anichini">Melania</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-4">
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.instagram.com/chesidario/">
                            <div class="profile-picture"
                                 style="background-image: url(<?php echo $BASE_URL ?>assets/profile-pictures/dario.jpg)">
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.instagram.com/chesidario/">Dario</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-4">
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.lorenzovainigli.com">
                            <div class="profile-picture"
                                 style="background-image: url(<?php echo $BASE_URL ?>assets/profile-pictures/lorenzo.jpg)">
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <a href="https://www.lorenzovainigli.com">Lorenzo</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <?php switch (get_lang()) {
                    case "it": ?>
                        <p>Siamo tre studenti universitari di Siena. Abbiamo deciso di creare Nice Places
                            per offrire un nuovo tipo di esperienza per conoscere la storia e la cultura che
                            caratterizza la nostra città e i luoghi delle nostre zone, grandi espressioni di un fiorente
                            e ricco
                            passato medievale.</p>
                        <p>Dedichiamo a questo progetto parte del nostro tempo libero e ci auguriamo che possa diventare
                            un
                            mezzo
                            per divulgare la conoscenza di epoche passate in modo semplice e veloce, anche solo
                            utilizzando uno
                            smartphone.</p>
                        <?php break;
                    case "en": ?>
                        <p>We are three university students from Siena. We decided to create
                            Nice Places to offer a new kind of experience to learn about the history and culture that
                            characterizes our city and the places of our areas, great expressions of a flourishing and
                            rich
                            medieval past.</p>
                        <p>We dedicate part of our free time to this project and we hope that it will become a way to
                            spread the
                            knowledge of past times in a simple and fast way, even just using a mobile phone.</p>
                    <?php } ?>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="row">
            <div class="col">
                <blockquote>
                    ...
                    <h6>
                        <div class="author">
                            <a href="https://www.zerozone.it/provati-per-voi/nice-places-lapp-per-scoprire-posti-nuovi/14320"
                               target="_blank">
                ...
                <blockquote>
                    ...
                    <h6>
                        <div class="author">
                            <a href="https://xantarmob.altervista.org/nice-places-una-guida-artistica-italiana-da-provare-su-android/"
                               target="_blank">
                                Xantarmob
                            </a>
                        </div>
        ...
        <div class="row">
            <div class="col">
                <a class="anchor" name="partners"></a>
                <h2 class="section-header"><?php echo t("collaborazioni") ?></h2>
            </div>
        </div>
        <div class="row">
            <div class="col text-center">
                <a class="partner" href="http://www.prolocosovicille.it/" target="_blank">
                    <img src="<?php echo $BASE_URL ?>assets/icons/proloco.png" alt="Pro Loco Sovicille">
                </a>
            </div>
            <div class="col text-center">
                <a class="partner" href="https://www.facebook.com/camminodetruria/" target="_blank">
                    <img src="<?php echo $BASE_URL ?>assets/icons/cammino-d-etruria.jpg"
                         alt="Cammino d'Etruria">
                </a>
            </div>
            <div class="col text-center">
                <a class="partner" href="https://prolocomurlo.it/" target="_blank">
                    <img src="<?php echo $BASE_URL ?>assets/icons/proloco-murlo.jpeg"
                         alt="Pro Loco Murlo">
                </a>
            </div>
        </div>
    ...
    <section>
        <div class="row counters">
            ...
            <div class="col">
                ...
                <h1 class="counter-plus" data-count="1000">0</h1>
            </div>
            <div class="col">
                <h4><?php echo t("utenti-attivi") ?></h4>
                <h1 class="counter-plus" data-count="100">0</h1>
            </div>
        </div>
    </section>
...
<script src="<?php echo $BASE_URL ?>lib/js/popper.min.js"
        integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49"
        crossorigin="anonymous"></script>
<script src="<?php echo $BASE_URL ?>lib/js/bootstrap.min.js"
...
<script type="text/javascript" id="cookieinfo"
        ...
        data-bg="#645862"
        data-fg="#FFFFFF"
        data-message="<?php echo t("usiamo-i-cookie") ?>"
        data-link="#F1D600"
        data-linkmsg=""
        data-cookie="CookieInfoScript"
        data-text-align="left"
        data-close-text="<?php echo t("ho-capito") ?>">
</script>
